...
const padWithSpacesInCenter = function (longestStrLength) {
  return function (string) {
    ...
    return string
      .padStart(padStartLen + string.length, " ")
      .padEnd(longestStrLength, " ");
  };
};
...
// given a list of users, where each user has a list of messages, return an array of messages that contain the word "urgent" in [{ name: "Alice",
//  messages: ["Urgent: Pay bills", "Meeting at 3"] }, { name: "Bob", messages: ["Urgent: Call customer", "Check email"] }] => ["Urgent: Pay bills", "Urgent: Call customer"]
